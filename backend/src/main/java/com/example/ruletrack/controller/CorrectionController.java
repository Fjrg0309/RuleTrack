...
/**
 * Controlador de análisis de correcciones mediante IA.
 * Recibe el contenido de un documento y devuelve sugerencias de corrección
...
@Slf4j
@Tag(name = "Correcciones IA", description = "Análisis y sugerencias de corrección mediante LLM")
public class CorrectionController {

    private final LlmService llmService;

    @Operation(summary = "Analizar documento y obtener correcciones",
               description = "Envía el contenido de un documento al LLM y devuelve una lista de sugerencias de corrección.")
    @ApiResponses({
        @ApiResponse(responseCode = "200", description = "Análisis completado"),
        @ApiResponse(responseCode = "503", description = "Servicio LLM no disponible (API key no configurada o error de autorización)"),
